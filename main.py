...
def load_trained():
    env = gym.make('HalfCheetah-v4', ctrl_cost_weight=0.1, xml_file='half_cheetah.xml', reset_noise_scale=0.1, exclude_current_positions_from_observation=True, render_mode="human")


    agent = Agent(alpha=0.000025, beta=0.00025, input_dims=[18], tau=0.001, env=env, batch_size=64, layer1_size=400, layer2_size=300, n_actions=6)
